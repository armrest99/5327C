...
void autoFlywheelDrive(double velocity) {
  ...
  std::vector<double> stats = {flywheel.get_actual_velocity(),
                               (double)flywheel.get_current_draw(),
                               left_wheel_front.get_actual_velocity(),
                               (double)left_wheel_front.get_current_draw(),
                               left_wheel_middle.get_actual_velocity(),
                               (double)left_wheel_middle.get_current_draw(),
                               left_wheel_back.get_actual_velocity(),
                               (double)left_wheel_back.get_current_draw(),
                               intake.get_actual_velocity(),
                               (double)intake.get_current_draw(),
                               right_wheel_front.get_actual_velocity(),
                               (double)right_wheel_front.get_current_draw(),
                               right_wheel_middle.get_actual_velocity(),
                               (double)right_wheel_middle.get_current_draw(),
                               right_wheel_back.get_actual_velocity(),
                               (double)right_wheel_back.get_current_draw()};
  update_graph(stats, charts, series);
...
void autonomous() {
  ...
  chassis.set_drive_brake(MOTOR_BRAKE_HOLD); // Set motors to hold.  This
